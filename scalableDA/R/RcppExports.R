...
logit_reg_simple <- function(y, X, b, B, burnin = 500L, run = 500L, r0 = 20, mc_draws = 1E4L) {
    .Call('scalableDA_logit_reg_simple', PACKAGE = 'scalableDA', y, X, b, B, burnin, run, r0, mc_draws)
}
...
probit_reg_simple <- function(y, X, b, B, burnin = 500L, run = 500L, r0 = 20, mc_draws = 1E4L) {
    .Call('scalableDA_probit_reg_simple', PACKAGE = 'scalableDA', y, X, b, B, burnin, run, r0, mc_draws)
}

probit_reg_simple2 <- function(y, X, b, B, burnin = 500L, run = 500L, r0 = 20, mc_draws = 1E4L) {
    .Call('scalableDA_probit_reg_simple2', PACKAGE = 'scalableDA', y, X, b, B, burnin, run, r0, mc_draws)
}
